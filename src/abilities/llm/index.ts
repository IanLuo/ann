...
export function getAdapter(provider?: string, logRoot: string = process.cwd(), runId?: string): ProviderAdapter {
  ...
  return new OpenAICompatibleAdapter(entry, reg.defaults, logRoot, runId);
}
