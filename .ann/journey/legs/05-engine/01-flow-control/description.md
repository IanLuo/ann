...
id: `05-engine/01-flow-control` · status: **queued** (first task of R5; contract set, work pending)
...
- required inputs: design v3 · requirements-spec (AC-1–5, K1–K4) · tree-format-spec-v2 · ann-system-design §1
