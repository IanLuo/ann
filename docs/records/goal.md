...
- Canonical model: `01-goal/artifacts/design.md` (v3, locked @ fd1125c) · requirements: `02-grilling/01-spec-rework/artifacts/requirements-spec.md` · format: `tree-format-spec` (logical name — current version v3) · technique: `ann-system-design`.
