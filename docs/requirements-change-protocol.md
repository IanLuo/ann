## Link contract
- **upstream** (this doc relies on): tree/rounds/01-goal/artifacts/design.md,02-grilling/01-spec-rework/artifacts/requirements-spec.md docs/flow-control-spec.md,01-format-amendment-v2/artifacts/tree-format-spec-v2.md
